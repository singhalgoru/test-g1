...
| | URL |
|---|---|
| Preview | https://main--test-g1--singhalgoru.aem.page/ |
| Live    | https://main--test-g1--singhalgoru.aem.live/ |
...
- [ ] AEM Sites console → Create → Site from template
  - Title: **Test-G1** · Name: **test-g1** · GitHub: https://github.com/singhalgoru/test-g1
- [ ] Open Universal Editor → verify authoring → Quick Publish all pages
- [ ] Verify https://main--test-g1--singhalgoru.aem.page
